...
///
/// This is used to recover the original text of deleted/tombstone messages
/// (msg_type=15) that were later quoted by another message.  The quoting
/// message preserves the original text in message_quoted.text_data.
