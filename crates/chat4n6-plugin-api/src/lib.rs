...
mod tests {
    ...
    fn test_evidence_source_display() {
        ...
        assert_eq!(format!("{}", EvidenceSource::CarvedUnalloc { confidence: 0.94 }), "CARVED-UNALLOC 94%");
    ...
    fn test_timestamp_local_str_negative_offset() {
        ...
        assert_eq!(ts.local_str(), "2024-03-15 09:32:07 UTC-5");
    }

    #[test]
    fn test_timestamp_local_str_utc() {
        let ts = ForensicTimestamp::from_millis(1710513127000, 0);
        assert_eq!(ts.local_str(), "2024-03-15 14:32:07 UTC+0");
    }
